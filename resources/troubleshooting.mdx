...
description: Solve common issues and get back to messaging quickly with solutions to frequent problems
---

<img
  src="/docs-images/Standard image (for all pages that don't have special image).avif"
  alt="Stork SMS Troubleshooting Guide"
...
**Specific Wallet Troubleshooting**:
