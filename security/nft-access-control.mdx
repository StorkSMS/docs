---
title: NFT-Based Access Control
description: Innovative NFT-based access control system where only NFT holders can access their conversations
---

<img
  src="/docs-images/Standard image (for all pages that don't have special image).avif"
  alt="Stork SMS NFT Access Control"
