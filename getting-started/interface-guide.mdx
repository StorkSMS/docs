...
description: The Stork SMS interface is designed to be intuitive and familiar while incorporating Web3 elements seamlessly
---

<img
  src="/docs-images/image.avif"
  alt="Stork SMS Interface Guide"
